...
class Queen(Piece):
    ...
    def get_valid_moves(self, board: list) -> list:
        """
        Returns a list of valid moves for the queen
        ...
        """
        moves = []
        # Directions combine those of a Rook and a Bishop
        directions = [(-1, 0), (1, 0), (0, -1), (0, 1),  # Rook movements (straight)
                      (-1, -1), (-1, 1), (1, -1), (1, 1)]  # Bishop movements (diagonal)
